...
## u8g2.SetHzFont([path][, size][, antialias])
...
## u8g2.DrawHzfontText(x, y, text, size, antialias)
...
## u8g2.SetHzfontParams(size, antialias, threshold)
