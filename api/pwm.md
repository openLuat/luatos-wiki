...
-- 本库支持2套API风格
-- 1. 传统API, open和close
-- 2. 新的API, setup,start,stop,setDuty,setFreq

-- 传统API
pwm.open(5, 1000, 50) -- 打开PWM5, 频率1kHz, 占空比50%
sys.wait(5000) -- 等待5秒
pwm.close(5) -- 关闭PWM5

-- 新API
pwm.setup(5, 1000, 50) -- 设置PWM5, 频率1kHz, 占空比50%
pwm.start(5) -- 启动PWM5
sys.wait(5000) -- 等待5秒
pwm.setFreq(5, 2000) -- 设置PWM5频率2kHz
sys.wait(5000) -- 等待5秒
pwm.setDuty(5, 25) -- 设置PWM5占空比25%
sys.wait(5000) -- 等待5秒
pwm.stop(5) -- 关闭PWM5
