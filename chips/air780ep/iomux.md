...
|功能     |软件含义  |对应的GPIO|对应的PAD|备注|
|---------|---------|---------|---------|----|
|I2C0_SCL | I2C0时钟 | GPIO15   |    30   |与SPI1冲突|
|I2C0_SDA | I2C0数据 | GPIO14   |    29   |与SPI1冲突|
|I2C1_SCL | I2C1时钟 | GPIO18   |    13   |GPIO功能看后面描述|
|I2C1_SDA | I2C1数据 | GPIO19   |    14   |GPIO功能看后面描述|
